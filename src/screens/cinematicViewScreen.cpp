...
CinematicViewScreen::CinematicViewScreen()
{
    ...
    camera_lock_toggle = new GuiToggleButton(
        this, "CAMERA_LOCK_TOGGLE", "Lock camera on ship", [](bool value) {});
    camera_lock_toggle->setValue(true)->setPosition(20, -20, ABottomLeft)->setSize(300, 50)->hide();

    camera_lock_tot_toggle =
        new GuiToggleButton(this, "CAMERA_LOCK_TOT_TOGGLE",
                            "Lock camera on ship's target", [](bool value) {});
